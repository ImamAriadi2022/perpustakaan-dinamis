...
INSERT INTO `tb_pengguna` (`id_pengguna`, `nama_pengguna`, `username`, `password`, `role`) VALUES
(1, 'M ivan S', 'admin',md5('admin123'), 'Admin'),
(2, 'azka', 'tsora',md5('azka123'), 'user'),
(3,'Imam', 'imam',md5('imam123'), 'user');
